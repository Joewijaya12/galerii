        ...
        <div class="table">
            <div class="container-fluid mt-3">
                <div class="d-flex justify-content-center">
                    <table cellpadding=5 cellspacing=0 class="table-bordered table-striped table-secondary">
                        <tr>
                            <th>ID</th>
                            <th>Nama</th>
                            <th>Deskripsi</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_album.php?albumid=<?= $data['albumid'] ?>"><img src="icon/trash.png" alt="Hapus"></a>
                                    <a href="edit_album.php?albumid=<?= $data['albumid'] ?>"><img src="icon/file.png" alt="Edit"></a>
                                </td>
                            </tr>
                        <?php
                        }
